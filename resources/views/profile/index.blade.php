...
@section('content')
    <div class="col-lg-12 mbottom60">
        <img alt="" class="ProfileBanner" src="http://agrawalrelocation.com/images/profile_banner.jpg"
        ...
        @if($profile->id !== Auth::id())
            @if(Auth::user()->isFriendsWith($profile))
                <div class="friends mbottom30 pbottom30">
                    <p style="margin:10px 0 0 15px; ">je bent al vrienden met {{ $profile->firstname}}</p>
                </div>                   
            @else
                <div class="friends mbottom30 pbottom30">
